...
public class MovieStackWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.hawi.lukman.cataloguemovieuiux.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.hawi.lukman.cataloguemovieuiux.EXTRA_ITEM";
